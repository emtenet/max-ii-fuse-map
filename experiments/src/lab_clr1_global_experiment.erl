...
run_lab(Density, Device, Sources, Settings0, LAB, X, Y) ->
    ...
    %matrix:print(Matrix),
    [Clr1Global0] = matrix:pattern(Matrix, [0,0,1,1,1]),
    [Clr1Global1] = matrix:pattern(Matrix, [1,1,0,1,1]),
    [Clr1Global2] = matrix:pattern(Matrix, [1,1,1,0,1]),
    [Clr1Global3] = matrix:pattern(Matrix, [1,1,1,1,0]),
    [Clr1Invert]  = matrix:pattern(Matrix, [1,0,1,1,1]),
