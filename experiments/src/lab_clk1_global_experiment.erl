...
run_lab(Density, Device, Sources, Settings0, LAB, X, Y) ->
    ...
    [Clk1Global0] = matrix:pattern(Matrix, [0,0,1,1,1]),
    [Clk1Global1] = matrix:pattern(Matrix, [1,1,0,1,1]),
    [Clk1Global2] = matrix:pattern(Matrix, [1,1,1,0,1]),
    [Clk1Global3] = matrix:pattern(Matrix, [1,1,1,1,0]),
    [Clk1Invert]  = matrix:pattern(Matrix, [1,0,1,1,1]),
